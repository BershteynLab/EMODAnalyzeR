...
pop_scale_params <- setRefClass("pop_scale_params",
                                fields = list(year="numeric", population="numeric", age_min_inc="numeric", age_max_inc="numeric"))
...
#' @param pop_scaling_factor pop_scale_params or float population scaling factor. If < 1, it will be inverted.
...
report.calibration.results <- function(experiment_path, ingest_file_path, pop_scaling_factor = 1, figure_path = "./", completed_run=TRUE) {
  ...
  if (is.numeric(pop_scaling_factor)) {
    ...
    data = calculate.pop_scaling_factor( data,
                                         pop_scaling_factor$year,
                                         pop_scaling_factor$population,
                                         pop_scaling_factor$age_min_inc,
                                         pop_scaling_factor$age_max_inc)
  }
