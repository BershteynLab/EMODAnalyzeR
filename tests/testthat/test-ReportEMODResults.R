test_that("report.calibration.results doesnt error", {
# insert path to your reportbyageandgender files
path_to_report_by_age_and_gender <- "../test_data/ReportHIVByAgeAndGender"
...
path_to_ingest_file <- "../test_data/calibration_ingest_form_Nyanza.xlsm"
